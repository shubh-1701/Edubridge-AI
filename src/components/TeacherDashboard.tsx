...
export default function TeacherDashboard() {
  ...
  const toggleLive = async () => {
    ...
    // Open the teacher's room for them automatically in a new tab BEFORE async operations to bypass popup blockers
    let newWindow: Window | null = null;
    if (newLiveStatus) {
      newWindow = window.open(autoGeneratedLink, "_blank");
    }
